...
export default function DiscoverCommunitiesPage({ onBack }) {
  ...
  const CommunityCard = ({ community }) => (
    <div className="bg-[#0f0f0f] border border-gray-800 rounded-2xl p-4 hover:border-orange-500 transition-all duration-300">
  ...
  return (
    <div className="min-h-screen bg-black text-white pb-20 md:pb-0">
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-6 md:py-8">
        ...
        <div className="mb-8">
          <h2 className="text-base md:text-lg text-gray-300 mb-4">What are you looking for?</h2>
        ...
        {/* Recommended Section */}
        <div className="mb-10">
          <h2 className="text-lg md:text-xl font-semibold text-white mb-4">Recommended for you</h2>
        ...
        {/* Technology Section */}
        <div className="mb-10">
          <h2 className="text-lg md:text-xl font-semibold text-white mb-4">Technology</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        {/* Games Section */}
        <div className="mb-10">
          <h2 className="text-lg md:text-xl font-semibold text-white mb-4">Games</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
