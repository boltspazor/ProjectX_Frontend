...
export default function Stories() {
  ...
  return (
    <div className="w-full bg-black border-b border-gray-800 py-3 md:py-4 px-4 md:px-6">
      <div className="flex items-center gap-3 md:gap-4 overflow-x-auto scrollbar-hide">
        ...
        {stories.map((story) => (
          <div key={story.id} className="flex flex-col items-center gap-1 md:gap-2 flex-shrink-0">
            <div className="w-14 h-14 md:w-16 md:h-16 rounded-full p-[2px] bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-500 cursor-pointer">
