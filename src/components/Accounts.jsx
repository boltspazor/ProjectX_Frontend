          ...
          <div className="relative mb-12">
            ...
            >
              {sampleAccounts.map((account, i) => (
                ...
                >
                  <div className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-gray-200 dark:bg-gray-700 mb-3 border border-gray-300 dark:border-gray-600 hover:border-primary transition-all"></div>
